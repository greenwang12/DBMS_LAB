...
("01BMS653", "Student_4", "History", "2003-10-12"),
("01BMS234", "Student_5", "Computer Economics", "2001-10-10");
...
insert into TextBook values
(123456, "The Autobiography", "Pearson", "Shelly");
...
where e.course=c.course and e.regno="01BMS235";
...
DROP TRIGGER IF EXISTS DeleteRecords;
DELIMITER //
...
BEGIN
    DELETE FROM Enroll
    WHERE Enroll.course = OLD.course;
END;//
DELIMITER ;

-- Test for Trigger 1
-- This will delete from Enroll all rows whose course = 2
DELETE FROM Course WHERE course = 2;

DROP TRIGGER IF EXISTS PreventEnrollment;
DELIMITER //
...
-- Test for Trigger 2
-- This should raise the error: "Marks below threshold"
INSERT INTO Enroll VALUES
("01BMS235", 002, 5, 5);


INSERT INTO Enroll VALUES
("01BMS235",002, 5, 5); -- Gives error since marks is less than 10
